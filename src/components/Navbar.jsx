...
const Navbar = () => {
  ...
  return (
    <div className={"fixed -z-10 top-0 w-full xl:w-[calc(100vw - 530px)] h-[60px] flex items-center justify-between bg-white dark:bg-gray-800 border-0 border-b-[1px] border-solid " + `${theme === "dark" ? "border-b-gray-700" : "border-b-gray-200"}`}>
      <div className="xl:ml-[230px] py-3 px-7 flex items-center gap-7 h-full w-full">
