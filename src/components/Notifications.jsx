...
const Notifications = () => {
  ...
  return (
    <aside className={"fixed overflow-y-auto max-h-screen h-auto right-0 top-0 w-[300px] flex flex-col px-7 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 border-0 border-l-[1px] border-solid " + `${theme === "dark" ? "border-l-gray-700" : "border-l-gray-200"}`}>
      <div>
