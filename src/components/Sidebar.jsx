...
const Sidebar = () => {
  ...
  return (
			<aside className={"fixed hidden md:block z-60 px-7 py-3 top-0 left-0 w-[230px] h-full bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 border-0 border-r-[1px] border-solid " + `${theme === "dark" ? "border-r-gray-700" : "border-r-gray-200"}` }>
